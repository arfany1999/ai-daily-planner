    ...
    <div style={{ minHeight: '100vh', background: T.bg, color: T.text, padding: '24px' }}>
      <div style={{ maxWidth: 700, margin: '0 auto' }}>
        ...
        {[
          ...
          { t: 'Third-Party Services', b: 'We use: Google OAuth for authentication; Google Calendar API for calendar data; Anthropic Claude API for AI processing; Stripe for payments; Supabase for database + storage; Vercel for hosting. Each service has its own privacy policy governing the data they receive.' },
